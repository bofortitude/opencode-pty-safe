{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/michi/dev/opencode-pty-branches/ci/switch-to-biome";
  project_input_ref = "path:/home/michi/dev/opencode-pty-branches/ci/switch-to-biome";
  devenv_dotfile = "/home/michi/dev/opencode-pty-branches/ci/switch-to-biome/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-5621c82";
  ...
  hostname = "nixos";
  username = "michi";
  git_root = "/home/michi/dev/opencode-pty-branches/ci/switch-to-biome";
  secretspec = null;
};
    in
    {
